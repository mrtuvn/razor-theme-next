...
function Cart({}: Props) {
    return (
        <div className="my-cart flex items-center gap-2">
            <div className="relative rounded-full border-[2px] border-solid border-gray p-3">
                <span className="cart-count border-radius-[20px] absolute top-[-12px] left-[-5px] min-h-[20px] min-w-[20px] rounded-full bg-primary p-1 text-xs text-white">
                    12
                </span>
                <svg
                    width="18"
...
// return/export tsrfce a.k.a TS react function component
export default Cart;
